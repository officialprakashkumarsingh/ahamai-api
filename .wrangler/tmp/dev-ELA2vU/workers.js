...
async function tryModelRequest(modelId, requestBody, stream, corsHeaders) {
  ...
  const attemptOnce = /* @__PURE__ */ __name(async (internal) => {
...
// .wrangler/tmp/bundle-ljz7B5/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-ljz7B5/middleware-loader.entry.ts
